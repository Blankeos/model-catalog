      ...
      const merged = normalizeModel(
        {
          ...
          reasoning_options: patch.reasoning_options ?? existing.reasoning_options,
          limit: patch.limit ?? existing.limit,
          cost: patch.cost ?? existing.cost,
          provider: patch.provider ?? existing.provider,
          interleaved: patch.interleaved ?? existing.interleaved,
          experimental: patch.experimental ?? existing.experimental,
